import numpy as np
from inversion.Tools.UtilFunc import polyfitB,backtrack2
from inversion.LineSearch.LineSearch import LineSearch


class Bracket(LineSearch):
    ...
    def __init__(self,step_count_max=10,step_len_max=np.inf):
        LineSearch.__init__(self,step_count_max,step_len_max);
